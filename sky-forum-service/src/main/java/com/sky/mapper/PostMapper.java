...
public interface PostMapper {
    ...
    Page<PostVO> pageUserPost(UserPostDTO userPostDTO);

    Page<PostVO> pageUserFavor(UserFavorDTO userFavorDTO);

    void updatePostImages(Integer postId, String imagesJson);
}